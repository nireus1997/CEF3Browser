...
typedef struct tagTWindowShadowInfo
{
    RECT rTopLeft;
    RECT rTopRight;
    RECT rBottomLeft;
...
public:
    ...
    bool IsAlphaBackground() const;
    void CalRealShadowRect( RECT& rcClient, TWindowShadowInfo& realShadowInfo );
    void DrawWindowShadow(HWND wnd,RECT& rcPaint);
    void GenerateShadowRenderString( RECT& src, RECT& dst, LPTSTR sRenderString );
    void SetBottomrightShadowRect( int x, int y, int w, int h );
    void SetBottomleftShadowRect( int x, int y, int w, int h );
    void SetToprightShadowRect( int x, int y, int w, int h );
    void SetTopleftShadowRect( int x, int y, int w, int h );
    void SetIsWindowShadow(bool bShadow);
    bool IsWindowShadow() const;
    void SetHasWindowShadow(bool bShadow);
    bool HasWindowShadow() const;
    void SetWindowShadowImage( LPCTSTR pStrImage );
    void CalMiddleShadowRect();
...
private:
    ...
    TWindowShadowInfo m_shadowInfo;
