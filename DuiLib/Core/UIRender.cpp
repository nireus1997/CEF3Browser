...
// this problem.
// reference : http://stackoverflow.com/questions/5309914/updatelayeredwindow-and-drawtext
...
HBITMAP CRenderEngine::LoadImage(unsigned char* bytesImg, DWORD bytesLength, LPCTSTR type, DWORD mask)
{
	LPBYTE pImage = NULL;
	int x = 1, y = 1, n;
