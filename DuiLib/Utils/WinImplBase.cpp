...
LRESULT WindowImplBase::HandleMessage(UINT uMsg, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_SHOWWINDOW:     lRes = OnVisibleChanged(uMsg, wParam, lParam, bHandled); break;
...
LRESULT WindowImplBase::OnVisibleChanged( UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL& bHandled )
{
    bHandled = FALSE;
    return 0;
}
